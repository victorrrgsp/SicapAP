...
public class ConcessaoReadaptacaoController extends DefaultController<DocumentoReadaptacao> {
    ...
    public ResponseEntity<PaginacaoUtil<ReadaptacaoDTO>> listChaves(Pageable pageable, @PathVariable String searchParams, @PathVariable Integer tipoParams) {
        return ResponseEntity.ok().body(readaptacaoRepository
    ...
    public ResponseEntity<?> findById(@PathVariable BigInteger id) {
        return ResponseEntity.ok().body(readaptacaoRepository.findById(id));
    }
    ...
    public ResponseEntity<?> findSituacao(@PathVariable BigInteger id) {
        return ResponseEntity.ok().body(documentoReadaptacaoRepository.findSituacao("documentoReadaptacao", "idReadaptacao", id, "'I - Seção V', 'II - Seção V', 'VI - Seção V'"));
    }
    ...
    public ResponseEntity<?> findByDocumento(@PathVariable String inciso, @PathVariable BigInteger id) {
        return ResponseEntity.ok().body(documentoReadaptacaoRepository.buscarDocumentoReadaptacao(inciso, id));
    }
    ...
    private AdmEnvio preencherEnvio(BigInteger id, String ug) {
        ...
        admEnvio.setNumeroAto(readaptacao.getAto().getNumeroAto());

        SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        String dataFormatada = df.format(readaptacao.getAto().getDataPublicacao());
