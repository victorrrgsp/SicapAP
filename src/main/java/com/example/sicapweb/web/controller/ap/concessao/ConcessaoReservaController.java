...
public class ConcessaoReservaController extends DefaultController<DocumentoAposentadoria> {
    ...
    public ResponseEntity<?> addFile(@RequestParam("file") MultipartFile file, @PathVariable String inciso, @PathVariable BigInteger id, @RequestParam(value = "descricao", required = false) String descricao) throws UnknownHostException {
        ...
        String idCastor = super.setCastorFile(file, "AposentadoriaReserva");
    ...
    public ResponseEntity<?> findAllDocumentos() {
        ...
        for (Integer i = 0; i < list.size(); i++) {
            Integer quantidadeDocumentos = documentoAposentadoriaRepository.findSituacao("documentoAposentadoria", "idAposentadoria", list.get(i).getId(), "'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X'", "S", "N", "N", "N");
    ...
    public ResponseEntity<?> findSituacao(@PathVariable BigInteger id) {
        Integer situacao = documentoAposentadoriaRepository.findSituacao("documentoAposentadoria", "idAposentadoria", id, "'I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X'", "S", "N", "N", "N");
    ...
    public ResponseEntity<?> findInciso(@PathVariable BigInteger id) {
        ...
        list.add(new Inciso("V", "Certidão de tempo de contribuição",
                "Certidão de tempo de contribuição", "", "Sim"));
    ...
    public ResponseEntity<?> findByDocumento(@PathVariable String inciso, @PathVariable BigInteger id) {
        DocumentoAposentadoria list = documentoAposentadoriaRepository.buscarDocumentoAposentadoriaReserva(inciso, id).get(0);
        return ResponseEntity.ok().body(list);
    }
    ...
    private AdmEnvio preencherEnvio(BigInteger id) {
        ...
        admEnvio.setTipoRegistro(AdmEnvio.TipoRegistro.RESERVA.getValor());
