...
public class ConcessaoRevisaoReservaController extends DefaultController<DocumentoAposentadoria> {
    ...
    public ResponseEntity<?> findInciso(@PathVariable BigInteger id) {
        ...
        list.add(new Inciso("II", "Requerimento de reserva",
                "Requerimento de reserva devidamente preenchido e assinado pelo interessado",
                "", "Sim"));
        list.add(new Inciso("III", "Documento de identidade e de inscrição no Cadastro de Pessoas " +
                "Físicas ? CPF/MF, certidão de nascimento ou de casamento",
                "Documento de identidade e de inscrição no Cadastro de Pessoas Físicas ? CPF/MF, certidão de " +
                        "nascimento ou de casamento", "", "Sim"));
        list.add(new Inciso("IV", "Último contracheque",
                "Último contracheque", "", "Sim"));
        list.add(new Inciso("V", "Certidão de tempo de contribuição",
                "Certidão de tempo de contribuição expedida por órgão gestor de regime previdenciário, caso " +
                        "tenha exercido emprego anterior ao ingresso na Polícia Militar", "", "Sim"));
        list.add(new Inciso("VI", "Ato de concessão do benefício",
                "Ato de concessão do benefício, firmado na forma da lei de regência e acompanhado da respectiva " +
                        "publicação, constando o nome, a graduação até então ocupada, o valor dos proventos, a " +
                        "fundamentação legal para a concessão, bem como a data a partir da qual o militar será considerado inativo",
                "", "Sim"));
        ...
        list.add(new Inciso("VIII", "Informação emitida pelo instituto de previdência",
                "Informação emitida pelo instituto de previdência ao qual o interessado esteja vinculado, " +
                        "constando o demonstrativo de apuração do tempo de contribuição e de cálculo do benefício",
                "", "Sim"));
        list.add(new Inciso("IX", "Declaração de não acumulação de proventos",
                "Declaração de não acumulação de proventos, nos termos da legislação correspondente",
                "", "Sim"));
        ...
        list.add(new Inciso("XI", "Laudo pericial",
                "Laudo pericial, com a indicação da moléstia que ensejou a incapacidade definitiva do militar, " +
                        "nos casos de reforma por invalidez", "", "Não"));
    ...
    public ResponseEntity<?> findByDocumento(@PathVariable String inciso, @PathVariable BigInteger id) {
        return ResponseEntity.ok().body(documentoAposentadoriaRepository.buscarDocumentoRevisaoReserva(inciso, id));
    }
